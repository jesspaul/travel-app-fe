...
const Detail = (props) => {
    return (
        <li>
            ...
            { props.cityState.editDetailMode === props.detail._id ?
            <DetailForm
                cityState={props.cityState}
                handleDetailChange={props.handleDetailChange}
                handleDetailSubmit={props.handleDetailSubmit}
            />
            : <button className='detail-button' onClick={() => props.toggleDetailEditMode(props.detail._id)}><i class="fas fa-pencil-alt"></i></button> }
